...
const Footer = () => {
  return (
    <section className="bg-blue-900 py-10 sm:pt-16 lg:pt-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col justify-between gap-x-12 gap-y-12 sm:flex-row md:grid-cols-4">
          <div>
            <div>
              <div className="flex flex-row items-center justify-start space-x-4">
                <Image
                  ...
                  height={80}
                />
                <p className="text-2xl font-semibold text-white">Siamal</p>
              </div>
          ...
          <div className="flex flex-row items-center justify-between sm:space-x-20">
            <div>
        ...
        <div className="mt-20 md:mt-28 2xl:mt-32">
          <div className="lg:flex lg:items-center lg:justify-between">
            <div className="sm:flex sm:items-center sm:justify-start sm:space-x-8">
              ...
              <ul className="mt-5 flex flex-wrap items-center justify-start gap-x-8 gap-y-3 sm:mt-0">
                <li>
                  <a
                    href="#"
                    title=""
            ...
            <p className="mt-6 text-sm text-blue-200 lg:mt-0">
              © Copyright 2024, All Rights Reserved by Siamal
            </p>
          </div>
        </div>
      </div>
